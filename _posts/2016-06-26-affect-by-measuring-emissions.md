...
<div style="background-color: #EEE; border: 1px solid black; padding: 5px; font-size: 12px;">
  <div style="border: 1px solid gray; padding: 5px; margin: 5px;">
    ...
    I know you had an <a href="/quantum/2015/10/26/Quantum-Zeno-Effect.html">earlier post about Zeno</a> but it didn't have a circuit diagram in it. My guess is that the Qbit should have a fixed initial state and then small rotations applied along the top line, but that the presence of the conditional gates may help to preserve the Qbit in its original state?
  </div>
